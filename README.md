...
- [HTMLCSSI](#htmlcssi)
- [Aula 1: Iniciando HTML](#aula-1--iniciando-html)
    - [1.1 Aplicando o DocType na Pag HTML (Define a versão mais recente do HTML)](#11-aplicando-o-doctype-na-pag-html-define-a-versao-mais-recente-do-html)
        - [1.1.1 O que é DocType e para o que serve?](#111-o-que-e-doctype-e-para-o-que-serve)
        - [1.1.2 Como aplicar o doctype?](#112-como-aplicar-o-doctype)
    - [1.2 Atribuindo Tags HTML (Estrutura onde ficara todos os conteudo do site)](#12-atribuindo-tags-html-estrutura-onde-ficara-todos-os-conteudo-do-site)
    - [1.3 Entendo as diferença entre as 3 TAGS](#13-entendo-as-diferenca-entre-as-3-tags)
    - [HTML](#html)
    - [HEAD](#head)
    - [BODY](#body)
    - [1.4 Atribuindo Tag LINK REL (diz que tipo de conteúdo que queremos referenciar com ela)](#14-atribuindo-tag-link-rel-diz-que-tipo-de-conteudo-que-queremos-referenciar-com-ela)
    - [1.5 Atribuindo Tag LINK > href (diz onde esse conteúdo se encontra)](#15-atribuindo-tag-link-href-diz-onde-esse-conteudo-se-encontra)
    - [1.6 Atribuindo Tag META > charset="utf-8" (indicando que nossa página usa a codificação de caracteres UTF-8)](#16-atribuindo-tag-meta-charsetutf-8-indicando-que-nossa-pagina-usa-a-codificacao-de-caracteres-utf-8)
    - [1.7 Adicionando title na Aba do Navegador.. dando um titulo ao nosso site](#17-adicionando-title-na-aba-do-navegador-dando-um-titulo-ao-nosso-site)
    - [1.8 Diferenças entre tags ```<p>``` = Paragrafos, ```<strong>``` = Formatação em Negrito, ```<em>``` = Italico, e atribuindo a pag html](#18-diferencas-entre-tags-p-paragrafos--strong-formatacao-em-negrito--em-italico--e-atribuindo-a-pag-html)
    - [1.9 Iniciando Blog index.](#19-iniciando-blog-index)
- [Aula 2: Introdução ao CSS](#aula-2--introducao-ao-css)
    - [2.1 Criando estilo na pagina HTML bio e blog](#21-criando-estilo-na-pagina-html-bio-e-blog)
    - [2.2 Atribuindo estilo a uma tag especifica Exemplo:](#22-atribuindo-estilo-a-uma-tag-especifica-exemplo)
    - [2.3 Atribuindo Tag <p> com estilo](#23-atribuindo-tag-p-com-estilo)
    - [2.4 Criando Estilo separado em um novo arquivo!!! css/estilo.css](#24-criando-estilo-separado-em-um-novo-arquivo-css-estilocss)
    - [2.5 Chamando estilo atravez da tag](#25-chamando-estilo-atravez-da-tag)
    - [2.6 Adicionando e alterando fontes a elementos de texto, com fonte principal e fontes secundaria(Caso o usuario nao tiver a primeira fonte)](#26-adicionando-e-alterando-fontes-a-elementos-de-texto--com-fonte-principal-e-fontes-secundariacaso-o-usuario-nao-tiver-a-primeira-fonte)
    - [2.7 Entendendo as cores RGB(255,255,255) Vermelho, Verde, Azul,...](#27-entendendo-as-cores-rgb255-255-255-vermelho--verde--azul)
    - [2.8 Cores mais especificas hexadecimal, #FFF, #EE8...](#28-cores-mais-especificas-hexadecimal--fff--ee8)
- [Aula 3: Aprofundando no HTML](#aula-3--aprofundando-no-html)
    - [3.1 Atribuindo links em textos](#31-atribuindo-links-em-textos)
    - [3.2 Adicionando IMG na pagina](#32-adicionando-img-na-pagina)
    - [3.3 Tag alt="" tornando a pagina mais acessivel a deficientes visuais.](#33-tag-alt-tornando-a-pagina-mais-acessivel-a-deficientes-visuais)
    - [3.4 Atribuindos citaçoes com tags ```<blockquote>``` e tag ```<cite>```](#34-atribuindos-citacoes-com-tags-blockquote-e-tag-cite)
    - [3.5 HTML e Semântica ```<main>```: conteúdo principal da página](#35-html-e-semantica-main--conteudo-principal-da-pagina)
    - [3.6 outras tags importantantes com semântica](#36-outras-tags-importantantes-com-semantica)
    - [3.7 Listas com tag ```<ul>``` e ```<li>```](#37-listas-com-tag-ul-e-li)
    - [3.8 Criando entidades no HTML](#38-criando-entidades-no-html)
    - [3.9 Seletores de descendência](#39-seletores-de-descendencia)
- [Aula 4: O navegador trabalhando ao nosso favor](#aula-4--o-navegador-trabalhando-ao-nosso-favor)
    - [4.1 Abrindo inspetor de paginas no google crhome](#41-abrindo-inspetor-de-paginas-no-google-crhome)
    - [4.2 Atribuindo e editando propriedades do HTML e CSS](#42-atribuindo-e-editando-propriedades-do-html-e-css)
    - [4.1 Resolvendo ou procurando erros de digitação onde o inspetor mostra em casos dificeis.](#41-resolvendo-ou-procurando-erros-de-digitacao-onde-o-inspetor-mostra-em-casos-dificeis)
    - [4.1 Usando o inspetor a nosso favor para melhor criação de uma pagina HTML, CSS](#41-usando-o-inspetor-a-nosso-favor-para-melhor-criacao-de-uma-pagina-html--css)
    - [4.1 Alterando a página pelo próprio navegador](#41-alterando-a-pagina-pelo-proprio-navegador)
    - [4.1 Atribuindo estilo pelo proprio elemento do inspetor, ou alterando tags](#41-atribuindo-estilo-pelo-proprio-elemento-do-inspetor--ou-alterando-tags)
- [Aula 5: Aprimorando o Layout](#aula-5--aprimorando-o-layout)
    - [5.1 Aplicando Espaçamento entre elementos ultilizando Padding , margin](#51-aplicando-espacamento-entre-elementos-ultilizando-padding---margin)
    - [5.2 Propriedades Width , Height que controla apenas o tamanho de um elemento](#52-propriedades-width---height-que-controla-apenas-o-tamanho-de-um-elemento)
    - [5.1 Propriedades Box-Sizing controla apenas como a largura e a altura de um elemento deve ser calculada.](#51-propriedades-box-sizing-controla-apenas-como-a-largura-e-a-altura-de-um-elemento-deve-ser-calculada)
    - [5.1 Propriedades Line-height controla apenas a altura entre as linhas de texto da página](#51-propriedades-line-height-controla-apenas-a-altura-entre-as-linhas-de-texto-da-pagina)
    - [5.1 Atribuindo Bordas nos elementos, Tipos de bordas e espaçamentos e cores](#51-atribuindo-bordas-nos-elementos--tipos-de-bordas-e-espacamentos-e-cores)
- [Aula 6: Construindo uma base sólida](#aula-6--construindo-uma-base-solida)
    - [6.1 Aplicando estilo de Reset.css na pagina , resetando estilos padroes de navegadores.](#61-aplicando-estilo-de-resetcss-na-pagina---resetando-estilos-padroes-de-navegadores)
    - [6.2 Entendendo e atribuindo ordem de estilo, e o que pode afetar.](#62-entendendo-e-atribuindo-ordem-de-estilo--e-o-que-pode-afetar)
    - [6.1 Entendo sobre conflitos no css.](#61-entendo-sobre-conflitos-no-css)
- [Aula 7: Um pouquinho de posicionamento](#aula-7--um-pouquinho-de-posicionamento)
    - [7.1 Atribuindo Posicionamento em propriedades da pagina](#71-atribuindo-posicionamento-em-propriedades-da-pagina)
    - [7.2 atribuindo css display](#72-atribuindo-css-display)
    - [7.3 Display : inline, block , inline-block, none.](#73-display---inline--block---inline-block--none)
- [Aula 8: Mais seletores](#aula-8--mais-seletores)
    - [8.1 Atribuindo novas funcionalidades ao css...](#81-atribuindo-novas-funcionalidades-ao-css)
    - [8.2 aplicando novas regras como CLASS e ID's](#82-aplicando-novas-regras-como-class-e-ids)
    - [8.3 Verificando as diferenças entre os atributos class e id's](#83-verificando-as-diferencas-entre-os-atributos-class-e-ids)
    - [8.4 testando e aplicando na pagina html](#84-testando-e-aplicando-na-pagina-html)
    - [8.5 Conflito entre classes e id.](#85-conflito-entre-classes-e-id)
    - [8.6 Temos um conflito, porém Todos os elementos <div> terão fundo azul.](#86-temos-um-conflito--porem-todos-os-elementos-div-terao-fundo-azul)
    - [8.7 Assim ultilizando o critério de desempate é qual das classes aparece por último no arquivo CSS](#87-assim-ultilizando-o-criterio-de-desempate-e-qual-das-classes-aparece-por-ultimo-no-arquivo-css)
- [Aula 9: Nem tudo é o que parece](#aula-9--nem-tudo-e-o-que-parece)
    - [9.1 Atribuindo transformaçoes de texto em ultilizando text-transform uppercase e lowercase](#91-atribuindo-transformacoes-de-texto-em-ultilizando-text-transform-uppercase-e-lowercase)
    - [9.2 Adicionando Image replacement: Dentro da folha de estilo:](#92-adicionando-image-replacement--dentro-da-folha-de-estilo)
    - [9.3 Display Blocks nos links](#93-display-blocks-nos-links)
    - [9.4 Image replacement e ferramentas de buscas...](#94-image-replacement-e-ferramentas-de-buscas)
    - [9.5 Aplicando e entendendo text-indent -9999 ou font-size 0px; ambos remove o texto..](#95-aplicando-e-entendendo-text-indent--9999-ou-font-size-0px--ambos-remove-o-texto)
- [Aula 10: Posicionamento mais a fundo](#aula-10--posicionamento-mais-a-fundo)
    - [10.1 Tipos de conteudos flutuantes](#101-tipos-de-conteudos-flutuantes)
    - [10.2 Float right e left "Posicionando elementos a direita e esquerda"](#102-float-right-e-left-posicionando-elementos-a-direita-e-esquerda)
    - [10.3 Ultilizando box sizing- border box](#103-ultilizando-box-sizing--border-box)
    - [10.4 Propriedades Clear . Left , right , both "Elimina espaço na esquerda, direita . ou em ambos"](#104-propriedades-clear-left---right---both-elimina-espaco-na-esquerda--direita-ou-em-ambos)
- [Aula 11: Elementos onde queremos](#aula-11--elementos-onde-queremos)
    - [11.1 Propriedades Position. ("Relative , absolute e fixed")](#111-propriedades-position-relative---absolute-e-fixed)
    - [11.1 Relative , Realtivo a posição original do elemento](#111-relative---realtivo-a-posicao-original-do-elemento)
    - [11.1 Absolute , com ele podemos colocar um elemento onde quisermos na página](#111-absolute---com-ele-podemos-colocar-um-elemento-onde-quisermos-na-pagina)
    - [11.1 Fixed , Fixamos um elemento independentemente da posição da rolagem da página no navegador.](#111-fixed---fixamos-um-elemento-independentemente-da-posicao-da-rolagem-da-pagina-no-navegador)
    - [11.1 Todas propriedades usam elementos como top , left , right , bottom.](#111-todas-propriedades-usam-elementos-como-top---left---right---bottom)
- [Aula 12: Desafios Finais](#aula-12--desafios-finais)
    - [12.1 Testando conhecimento aprendindo durante todo o curso](#121-testando-conhecimento-aprendindo-durante-todo-o-curso)
<!-- GUI AQUI:
